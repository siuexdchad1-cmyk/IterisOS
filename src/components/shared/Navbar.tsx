...
import { Cpu, Activity, ShieldCheck, Zap, ChevronRight, X, Sparkles } from 'lucide-react';
            ...
            {navItems.map((item) => {
              ...
              return (
                ...
                >
                  {isActive && (
                    <motion.div
                      layoutId="activeNavIndicatorShared"
